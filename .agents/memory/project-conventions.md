...
## Local Server & Preview URLs
- SEMPRE usar `http://127.0.0.1:5500` (Live Server padrão do usuário) ou `http://127.0.0.1:8000`.
- NUNCA inventar outras portas arbitrárias (como 8085, etc.).
